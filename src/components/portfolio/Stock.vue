    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="pull-right"><button class="btn btn-success" @click="sellStock" :disabled="insufficientQuantity || quantity <= 0 || !Number.isInteger(quantity)">{{ insufficientQuantity ? 'Not enugh' : 'Sell'}}</button></div>
            </div>
        </div>
    </div>
</template>
